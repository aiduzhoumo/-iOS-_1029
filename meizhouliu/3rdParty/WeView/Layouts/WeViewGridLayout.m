                          ...
                          debugIndent:(int)indent
{
    ...
    NSUInteger rowCount = result.rowCount = rowAndColumnCount.rowCount;
    NSUInteger columnCount = result.columnCount = rowAndColumnCount.columnCount;
    ...
    GridLayoutInfo *gridLayoutInfo = [self getGridLayoutInfo:view
                                         ...
                                         isAbstractSizeQuery:NO
                                          isMinimumSizeQuery:NO
                                                       debug:debugLayout
                                                 debugIndent:indent];
    NSUInteger columnCount = gridLayoutInfo.columnCount;
